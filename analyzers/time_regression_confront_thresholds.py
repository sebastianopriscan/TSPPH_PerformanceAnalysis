...
def analyze_data(resources_dir, results_dir, policy, param):
  """
  ...
  for filename in os.listdir(resources_dir):
    ...
    result_file = os.path.join(results_dir, f"{filename[:-4]}_time_{param}_thr_{policy}.txt")
...
analyze_data(resources_dir, results_dir, "3", "min_sav")
analyze_data(resources_dir, results_dir, "10", "min_sav")
analyze_data(resources_dir, results_dir, "18", "min_sav")

# Set labels and title
plt.xlabel("Size")
plt.ylabel("Time")
plt.title("Confronting Execution Time Regressions - min_sav")
...
analyze_data(resources_dir, results_dir, "3", "max_sav")
analyze_data(resources_dir, results_dir, "10", "max_sav")
analyze_data(resources_dir, results_dir, "18", "max_sav")

# Set labels and title
plt.xlabel("Size")
plt.ylabel("Time")
plt.title("Confronting Execution Time Regressions - max_sav")
...
analyze_data(resources_dir, results_dir, "3", "avg_sav")
analyze_data(resources_dir, results_dir, "10", "avg_sav")
analyze_data(resources_dir, results_dir, "18", "avg_sav")

# Set labels and title
plt.xlabel("Size")
plt.ylabel("Time")
plt.title("Confronting Execution Time Regressions - avg_sav")
plt.grid(True)
